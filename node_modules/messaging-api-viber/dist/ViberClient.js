...
function transformMessageCase(message) {
    ...
    return Object.assign(Object.assign(Object.assign({}, (0, messaging_api_common_1.snakecaseKeysDeep)(others)), (keyboard ? { keyboard: (0, messaging_api_common_1.pascalcaseKeysDeep)(keyboard) } : undefined)), (richMedia
        ? {
            richMedia: (0, messaging_api_common_1.pascalcaseKeysDeep)(richMedia),
        }
        : undefined));
}
/**
...
class ViberClient {
    constructor(config) {
        (0, ts_invariant_1.default)(typeof config !== 'string', `ViberClient: do not allow constructing client with ${config} string. Use object instead.`);
    ...
    static connect(config) {
        (0, warning_1.default)(false, '`ViberClient.connect(...)` is deprecated. Use `new ViberClient(...)` instead.');
    ...
    callAPI(path, body = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (0, messaging_api_common_1.snakecaseKeys)(body, { deep: false }));
